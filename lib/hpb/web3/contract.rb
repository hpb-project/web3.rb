    ...
    class Contract
      ...
      class ContractInstance
        ...
        def method_missing(method, *args)
          @contract.call_contract @address, method.to_s, args
        end
      ...
      class ContractMethod
        ...
        include HPB::Web3::Abi::AbiCoder
        include HPB::Web3::Abi::Utils
      ...
      attr_reader :client, :abi, :functions, :events, :constructor, :functions_by_hash, :events_by_hash

      def initialize(abi, web_rpc)
        @client = web_rpc
      ...
      def call_contract(contract_address, method_name, args)
        ...
        function.do_call client, contract_address, args
      end
